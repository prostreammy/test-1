...
export default async function handler(req) {
  const BASE_URL = "https://load.perfecttv.net/mpd/bola1/";
  const MANIFEST_URL = "https://load.perfecttv.net/mpd/bola1/manifest.mpd?username=vip_r92bmh1k&password=yb3IpqrB&channel=bola1fhd";
