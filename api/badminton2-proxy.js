...
export default async function handler(req) {
  const BASE_URL = "https://load.perfecttv.net/mpd/badminton2/";
  const MANIFEST_URL = "https://load.perfecttv.net/mpd/badminton2/manifest.mpd?username=vip_r92bmh1k&password=yb3IpqrB&channel=badminton2";
