...
export default async function handler(req) {
  const BASE_URL = "http://linearjitp-playback.astro.com.my/dash-wv/linear/1003/";
  const MANIFEST_URL = "https://get.perfecttv.net/dash2.mpd?username=vip_r92bmh1k&password=yb3IpqrB&channel=golf";
